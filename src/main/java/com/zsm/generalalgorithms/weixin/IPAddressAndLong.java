...
public class IPAddressAndLong
{
    ...
    public static String conversionIp(int num)
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            //计算当前位置的 ip 段，转换为 0 ~ 255 的数字，注意这里必须使用无符号右移
    ...
    {
        int i = conversionInt("127.0.0.1");
        String ip = conversionIp(i);
        System.out.println("Number is " + i + " IP string is " + ip);//Number is -1 IP string is 255.255.255.255
    }
